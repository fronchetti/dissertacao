...
%
% Except where otherwise indicated, these files are distr ibuted under
...
% metadados do PDF.
\title{Um Modelo de Classificação de Documentação para Novatos em Projetos de Software Livre}
\author{Luiz Felipe Fronchetti Dias}
...
\definecolor{darkgray}{RGB}{209, 209, 209}
