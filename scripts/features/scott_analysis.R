...
text(x = 1:length(sk_BW$groups),
     ...
     xpd = NA,
     srt = -20,
     col=c("#0F9D58", "#4285F4", "#a36a00", "#a36a00", "#DB4437"),
     adj = 0,
     cex = 2.5)
mtext("Média", side=2, line=5, cex=3)
mtext("Características agrupadas por cor", side=1, line=2.5, cex=3, padj=5)
...
axis(side = 1, labels = FALSE)
text(x = 1:length(sk_TC$groups),
     y = par("usr")[3] - 0.03,
     labels = names(sk_TC$groups),
     xpd = NA,
     srt = -20,
     col=c("#0F9D58", "#4285F4", "#4285F4", "#a36a00", "#DB4437"),
     adj = 0,
     cex = 2.5)
mtext("Média", side=2, line=5, cex=3)
mtext("Características agrupadas por cor", side=1, line=2.5, cex=3, padj=5)
...
axis(side = 1, labels = FALSE)
text(x = 1:length(sk_DC$groups),
     y = par("usr")[3] - 0.07,
     labels = names(sk_DC$groups),
     xpd = NA,
     srt = -20,
     col=c("#0F9D58", "#4285F4", "#4285F4", "#4285F4", "#a36a00"),
     adj = 0,
     cex = 2.5)
mtext("Média", side=2, line=5, cex=3)
mtext("Características agrupadas por cor", side=1, line=2.5, cex=3, padj=5)
...
axis(side = 1, labels = FALSE)
text(x = 1:length(sk_SC$groups),
     y = par("usr")[3] - 0.07,
     labels = names(sk_SC$groups),
     xpd = NA,
     srt = -20,
     col=c("#0F9D58", "#4285F4", "#4285F4", "#a36a00", "#DB4437"),
     adj = 0,
