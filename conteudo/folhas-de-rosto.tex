...
\tituloport{Um Modelo de Classificação de Documentação para Novatos em Projetos de Software Livre}

% Se "\title" está em português, você pode definir o título em inglês aqui
%\tituloeng{Análise de Documentação para Novatos em Projetos de Software Livre}

% Se o trabalho não tiver subtítulo, basta remover isto.
%\subtitulo{Análise de Documentação para Novatos em Projetos de Software Livre}

% Se isto não for definido, "\subtitulo" é utilizado no lugar
%\subtituloeng{Análise de Documentação para Novatos em Projetos de Software Livre}

\orientador[masc]{Prof. Dr. Marco Aurélio Gerosa}

% Se isto não for definido, "\orientador" é utilizado no lugar
%\orientadoreng{Prof. Dr. Marco Aurélio Gerosa}

% Se não houver, remova
\coorientador[masc]{Prof. Dr. Igor Steinmacher}
...
financeiro da FAPESP (18/02596-1)}

% Se isto não for definido, "\apoio" é utilizado no lugar
%\apoioeng{During this work, the author was supported by FAPESP (18/02596-1)}

\localdefesa{São Paulo}

\datadefesa{30 de Julho de 2019}

% Se isto não for definido, "\datadefesa" é utilizado no lugar
%\datadefesaeng{July 30th, 2019}
...
\palavraschave{Software Livre e de Código Aberto. Novatos. Análise de Documentação.}
...
%This dissertation is dedicated to my entire family, in particular, to my grandparents José Maria and Irene, who taught me the meaning of respect, honor and hard work.
\end{dedicatoria}
