...
A elaboração deverá acontecer em dois passos:
\begin{itemize}
    ...
    Para que os participantes do estudo tenham entendimento a cerca do que deverá ser feito, um tutorial sobre este será preparado. Este tutorial deverá conter, ente outras coisas, a descrição das categorias estabelecidas na Seção \ref{sec:categorias}, a serem identificadas por eles durante o estudo, bem como os passos que cada participante deverá seguir durante o processo doe identificação destas categorias nas documentações dos projetos. Todo o material produzido será disponibilizado publicamente em formato digital.
\end{itemize}
